...
__twttrlr(function(using, provide, loadrunner, define) {
    provide("util/util", function(e) {
        ...
        function r(e) {
            return s(e, function(t, n) {
                d(n) && (r(n), v(n) && delete e[t]), (n === undefined || n === null || n === "") && delete e[t]
            }), e
        }
        function s(e, t) {
            for (var n in e)
        ...
        }(), p = t(Object.create) ? Object.create : function(e) {
            function t() {
            }
            return t.prototype = e, new t
        };
        e({aug: n,compact: r,forIn: s,forEach: o,filter: u,map: a,trim: f,indexOf: i,isNative: t,isObject: d,isEmptyObject: v,createObject: p,bind: h,toType: l,isType: c})
    });
    ...
    provide("util/env", function(e) {
        using("util/domready", "util/typevalidator", "util/logger", "tfw/util/globals", function(t, n, r, i) {
            ...
            }), e({retina: f,anyIE: l,ie6: c,ie7: h,ie9: p,cspEnabled: d,touch: v,cssTransitions: m})
        })
    });
    ...
    provide("tfw/util/tracking", function(e) {
        using("dom/cookie", "dom/delegate", "sandbox/minimal", "util/donottrack", "util/promise", "tfw/util/guest_cookie", "tfw/util/env", "util/iframe", "util/util", "$xd/json2.js", function(t, n, r, i, s, o, u, a, f) {
            ...
            function x(e, t, n, r) {
                ...
                if (i || s)
                    return;
                o = _(e), u = D(t, !!n, !!r), L(o, u, !0)
            }
            function T(e, n, r, s) {
                var a = c[n], l, h, p = o.guest_id_cookie;
                if (!a)
                    return;
                e = e || {}, s = !!s, r = !!r, h = e.original_redirect_referrer || document.referrer, s = s || i(h), l = f.aug({}, e), r || (k(l, "referrer", h), k(l, "widget", +u.isDynamicWidget()), k(l, "hask", +!!t("k")), k(l, "li", +!!t("twid")), k(l, p, t(p) || "")), s && (k(l, "dnt", 1), F(l)), j(a + "?" + P(l))
            }
            function N(e, t, n, r, i) {
                var s = C(e.target || e.srcElement);
                s.action = i || "click", x(s, t, n, r)
            }
            function C(e, t) {
                var n;
            ...
            function L(e, t, n) {
                ...
                if (!f.isObject(e) || !f.isObject(t))
                    return;
                s = f.aug({}, t, {event_namespace: e}), n ? (u += P({l: I(s)}), j(u)) : (r = d.firstChild, r.value = +r.value || +s.dnt, o = I(s), i = y.createElement("input"), i.type = "hidden", i.name = "l", i.value = o, d.appendChild(i))
            }
            function A(e, t, n, r) {
                var i = !f.isObject(e), s = t ? !f.isObject(t) : !1, o, u;
                if (i || s)
            ...
            function D(e, t, n) {
                ...
                return t = !!t, n = !!n, s = f.aug(r, e || {}), o = s.widget_origin || document.referrer, s.format_version = 1, s.dnt = n = n || i(o), s.triggered_on = s.triggered_on || +(new Date), t || (s.widget_origin = o), n && F(s), s
            }
            function P(e) {
                var t = [], n, r, i;
                for (n in e)
            ...
            o.forceNewCookie(), e({enqueue: A,flush: O,initPostLogging: S,scribeInteraction: N,extractTermsFromDOM: C,addPixel: x,addLegacyPixel: T,addVar: k})
        })
    });
    ...
    provide("tfw/util/assets", function(e) {
        using("util/env", function(t) {
            ...
            var n = {"embed/timeline.css": {"default": "embed/timeline.ee147bcbf5e774abb96918271de549dc.default.css","2x": "embed/timeline.ee147bcbf5e774abb96918271de549dc.2x.css",gif: "embed/timeline.ee147bcbf5e774abb96918271de549dc.gif.css","default.rtl": "embed/timeline.ee147bcbf5e774abb96918271de549dc.default.rtl.css","2x.rtl": "embed/timeline.ee147bcbf5e774abb96918271de549dc.2x.rtl.css","gif.rtl": "embed/timeline.ee147bcbf5e774abb96918271de549dc.gif.rtl.css"}};
            e(r)
        })
    });
    provide("tfw/widget/syndicatedbase", function(e) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "tfw/util/tracking", "dom/classname", "dom/get", "dom/delegate", "sandbox/frame", "util/env", "util/promise", "util/twitter", "util/util", function(t, n, r, i, s, o, u, a, f, l, c, h, p) {
            function S() {
                y = x.VALID_COLOR.test(i.val("widgets:link-color")) && RegExp.$1, w = x.VALID_COLOR.test(i.val("widgets:border-color")) && RegExp.$1, b = i.val("widgets:theme")
            }
            function x(e) {
                if (!e)
                    return;
                ...
                }, this)), t.apply(this, [e]), n = this.params(), this.targetEl = this.srcEl && this.srcEl.parentNode || n.targetEl || document.body, this.predefinedWidth = x.VALID_UNIT.test(n.width || this.attr("width")) && RegExp.$1, this.layout(p.bind(function() {
            ...
            x.prototype = new t, p.aug(x.prototype, {setupSandbox: function(e) {
                    ...
                    this.headingStyle && t.push(p.map(g, e).join(",") + "{" + this.headingStyle + "}"), this.linkColor && (t.push(p.map(d, e).join(",") + "{color:" + this.linkColor + "}"), t.push(p.map(v, e).join(",") + "{background-color:" + this.linkColor + "}")), this.borderColor && t.push(p.map(m, e).concat(this.theme == "dark" ? [".thm-dark.customisable-border"] : []).join(",") + "{border-color:" + this.borderColor + "}");
                    if (!t.length)
                        return;
                    ...
                    function r(n) {
                        var r = u.ancestor(".tweet", this, t), i = p.aug({}, e.baseScribeData(), e.extractTweetScribeDetails(r));
                        s.scribeInteraction(n, i, !0, e.dnt)
                    }
                    var e = this, t = this.element;
                    a.delegate(t, "click", "A", r), a.delegate(t, "click", "BUTTON", r), a.delegate(t, "click", ".profile", function(t) {
                        var r;
                        if (t.altKey || t.metaKey || t.shiftKey)
                            return;
                        e.addUrlParams(this), r = h.intentForProfileURL(this.href), r && (n.open(r, e.sandbox.element()), a.preventDefault(t))
                    ...
                    var t = e.getAttribute("data-tweet-id"), n = e.getAttribute("data-rendered-tweet-id") || t, r = {};
                    return n == t ? r[n] = {item_type: E.TWEET} : t && (r[n] = {item_type: E.RETWEET,target_type: E.TWEET,target_id: t}), r
                    ...
                    return p.forEach(u.all("autosized-media", e), p.bind(function(e) {
                        var i = x.scaleDimensions(e.getAttribute("data-width"), e.getAttribute("data-height"), t, r);
                        this.layout(function() {
                            i.width > 0 && (e.width = i.width), i.height > 0 && (e.height = i.height)
                        }), n = i.height > n ? i.height : n
                    }, this)), n
                }}), x.VALID_UNIT = /^([0-9]+)( ?px)?$/, x.VALID_COLOR = /^(#(?:[0-9a-f]{3}|[0-9a-f]{6}))$/i, x.retinize = function(e) {
                if (!l.retina())
                    return;
            ...
            }, x.scaleDimensions = function(e, t, n, r) {
    ...
    provide("tfw/widget/timeline", function(e) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "util/promise", "anim/transition", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env", "util/throttle", "util/twitter", "util/querystring", "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function(t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b) {
            ...
            I.prototype = new n, m.aug(I.prototype, {renderedClassNames: "twitter-timeline twitter-timeline-rendered",dimensions: {DEFAULT_HEIGHT: "600",DEFAULT_WIDTH: "520",NARROW_WIDTH: "320",MIN_WIDTH: "180",MIN_HEIGHT: "200",WIDE_MEDIA_PADDING: 81,NARROW_MEDIA_PADDING: 16,WIDE_MEDIA_PADDING_CL: 60,NARROW_MEDIA_PADDING_CL: 12},create: function(e) {
                    ...
                    if (!i)
                        return;
                    return this.reconfigure(e.config), this.discardStaticOverflow(i), this.sandbox.setTitle(i.getAttribute("data-iframe-title") || "Timeline"), n.retinize(i), this.constrainMedia(i), this.searchQuery = i.getAttribute("data-search-query"), this.profileId = i.getAttribute("data-profile-id"), f = this.getTweetDetails(r), m.forIn(f, function(e) {
                        u.push(e)
                    }), o = this.baseScribeData(), o.item_ids = u, o.item_details = f, a.enqueue({page: "timeline",component: "timeline",element: "initial",action: u.length ? "results" : "no_results"}, o, !0, this.dnt), a.flush(), this.ariaPolite == "assertive" && (s = b.one(x, i, "DIV"), s.setAttribute("aria-polite", "assertive")), i.id = this.id, i.className += " " + this.classAttr.join(" "), i.lang = this.lang, this.augmentWidgets(i), this.ready().then(m.bind(function(e) {
                        e.appendChild(i), e.style({cssText: "",border: "none",maxWidth: "100%",minWidth: this.dimensions.MIN_WIDTH + "px"}), this.layout(m.bind(function() {
                            ...
                            this.width < this.predefinedWidth && (this.layout(m.bind(function() {
                    ...
                    var e = this, t = b.one(k, this.element), n = t && t.children[0], r = n && n.getAttribute("data-tweet-id");
                    ...
                    t && this.cursors.maxPosition ? s.minPosition = this.cursors.maxPosition : !t && this.cursors.minPosition ? s.maxPosition = this.cursors.minPosition : t ? s.sinceId = e : s.maxId = e, s.complete = function() {
                        ...
                        if (e && e.body !== undefined) {
                            ...
                            f.length && (u = i.baseScribeData(), u.item_ids = f, u.item_details = l, u.event_initiator = t ? E.CLIENT_SIDE_APP : E.CLIENT_SIDE_USER, a.enqueue({page: "timeline",component: "timeline",element: t ? "newer" : "older",action: "results"}, u, !0, i.dnt), a.flush()), n.retinize(o), i.constrainMedia(o);
                            while (o.children[0])
                    ...
                    }, 500), this.updateTimeStamps(), this.gcTweets(50)
    ...
    provide("tfw/widget/embed", function(e) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params", "dom/classname", "dom/get", "util/env", "util/promise", "util/util", "util/throttle", "util/twitter", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", function(t, n, r, i, s, o, u, a, f, l, c, h, p, d) {
            function w(e, t, n, r) {
                var i = o.one("subject", e, "BLOCKQUOTE"), s = o.one("reply", e, "BLOCKQUOTE"), u = i && i.getAttribute("data-tweet-id"), a = s && s.getAttribute("data-tweet-id"), l = {}, c = {};
                if (!u)
                    return;
                ...
                if (!a)
                    return;
                c[a] = {item_type: 0}, d.enqueue({page: "tweet",section: "conversation",component: "tweet",action: "results"}, f.aug({}, t, {item_ids: [a],item_details: c,associations: {4: {association_id: u,association_type: 4}}}), !0, r)
            }
            function E(e, t, n) {
                var r = {};
                if (!e)
    ...
    provide("tfw/widget/tweetbutton", function(e) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function(t, n, r, i, s, o) {
            function l(e) {
                ...
                else if (r.type == "mention" || ~n.indexOf(this.classAttr, "twitter-mention-button"))
            ...
            l.prototype = new t, n.aug(l.prototype, {parameters: function() {
                    ...
                    var r = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1383343979.html#" + this.parameters(), i;
    ...
    provide("tfw/widget/follow", function(e) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function(t, n, r, i, s, o, u) {
            ...
            a.prototype = new n, t.aug(a.prototype, {parameters: function() {
                    ...
                    var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1383343979.html#" + this.parameters(), i = this.create(r, this.dimensions(), {title: this._("Twitter Follow Button")}).then(t.bind(function(e) {
                        return this.element = e
                    }, this));
                    return n && i.then(n), i
                }}), e(a)
